"""
Django settings for libraryMgntSystem project.
...
SECRET_KEY = 'django-insecure-(7y+$dd73s!noadv-v64hj7@n09rt6$-t6w0#9x!7_9tdgj5-a'
...
ROOT_URLCONF = 'libraryMgntSystem.urls'
...
WSGI_APPLICATION = 'libraryMgntSystem.wsgi.application'
AUTHENTICATION_BACKENDS = ["libraryMgntSystem.backends.EmailOrUsernameModelBackend"]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': '/etc/mysql/lms.cnf',
        },
    }
}
